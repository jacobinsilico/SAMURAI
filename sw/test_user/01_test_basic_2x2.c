...
//
// Test program for user systolic-array accelerator.
...
int main(void)
{
    ...
    printf("Testing systolic array accelerator\n");
    ...
    *reg32(USER_DESIGN_BASE_ADDR, SA_CTRL_OFFSET) = 0x1;
    ...
    if (errors == 0) {
        printf("Systolic array test PASSED\n");
    } else {
        printf("Systolic array test FAILED with 0x%x errors\n", errors);
    }
